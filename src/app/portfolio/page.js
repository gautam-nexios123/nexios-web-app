...
const Portfolio = () => {
  return (
    <div className="relative">
      ...
      <div className="relative md:flex md:gap-16 lg:gap-24 w-full px-[30px] md:px-[60px] lg:px-[220px] py-[60px] my-6">
        <div className="font-MuseoSans text-[24px] text-[#121212] font-semibold pb-3 md:pb-0">
          Outwor,Successful client products
        </div>
        <div className="font-MuseoSans text-sm text-[#9BA9B4] font-normal text-justify">
