  ...
  return (
    <div className="relative">
      ...
      <div className="w-full mt-16">
        <div className="font-MuseoSans font-normal text-[14px] text-[#9BA9B4] w-[80%] md:w-[75%] lg:w-[60%] mx-auto text-justify md:text-center mb-4">
        ...
        <div className="font-MuseoSans font-normal text-[14px] text-[#9BA9B4] w-[80%] md:w-[75%] lg:w-[60%] mx-auto text-justify md:text-center mb-4">
          ...
          with servers, and it enables users to access data from these devices.
          The IoT has many potential benefits, including increased efficiency
          and automation, better customer service, and increased safety.
        </div>
        <div className="font-MuseoSans font-normal text-[14px] text-[#9BA9B4] w-[80%] md:w-[75%] lg:w-[60%] mx-auto text-justify md:text-center mb-4">
          BLE (Bluetooth Low Energy) is another important technology in the IoT.
          BLE is a short-range wireless technology that is used to connect
          devices that are close to each other. It’s especially useful in
          applications like smart homes and retail stores, where you want to
          connect devices like security cameras and sensors to smart devices in
          your home or store.
        </div>
      </div>
        ...
        <div className="w-[80%] lg:w-[70%] mx-auto flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-[50%]">
            ...
            <div className="font-MuseoSans text-[#9BA9B4] font-normal text-[14px] text-justify pb-2">
              ...
              to easily exchange data between devices by touching them together.
              This is important because it reduces the amount of data that needs
              to be transferred between devices, which can lead to faster and
              more efficient implementations of the IoT.
            </div>
            <div className="font-MuseoSans text-[#9BA9B4] font-normal text-[14px] text-justify pb-2">
